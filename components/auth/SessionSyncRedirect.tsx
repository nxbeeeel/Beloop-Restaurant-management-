                    ...
                    <div className="flex flex-col items-center space-y-6">
                        ...
                        {showControls && (
                            <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 w-full max-w-xs">
                                ...
                                {/* DEBUG DATA */}
                                <div className="mt-4 p-4 bg-stone-100 rounded text-[10px] font-mono text-stone-500 break-all border border-stone-200">
                                    <strong>User ID:</strong> {user?.id} <br />
                                    <strong>Role (DB):</strong> {user?.publicMetadata?.role ? String(user.publicMetadata.role) : 'MISSING'} <br />
                                    <strong>Meta:</strong> {JSON.stringify(user?.publicMetadata)}
                                </div>
                            </div>
                        )}
                    </div>
