...
export default async function HomePage() {
  ...
  // Middleware handles all role-based redirects for authenticated users checking '/'.
  // If we are here, it means the user is either:
  // 1. Not logged in (Public Visitor)
  // 2. Logged in but has no role/metadata yet (should rely on Middleware to send to Onboarding)

  // Note: We leave this pure landing page rendering. 
