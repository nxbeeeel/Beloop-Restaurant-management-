...
import { ExternalLink, Save, Loader2, Plus, X, GripVertical, Download } from 'lucide-react';
...
export default function OutletSettingsPage() {
    ...
    const { data: outletSettings, isLoading: isLoadingOutlet } = trpc.outlets.getSettings.useQuery(
        { outletId },
        { enabled: !!outletId }
    );
    ...
    if (!isLoaded || !outletId || isLoadingOutlet || isLoadingTenant) {
        return (
